...
// let numbersArr = [10,8,-7,55,987,-1011,0,1050,0];
// let strArr = numbersArr.map((item) => item.toString());
// console.log(strArr)
...
// console.log(filter);
// let changeElement = coursesAndDurationArray.map((item,index) => ({...item, id: index +1}));
